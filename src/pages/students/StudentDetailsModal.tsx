...
const StudentDetailModal: React.FC<StudentDetailModalProps> = ({ student, onClose }) => {
    ...
    const downloadReportCard = async (id: number) => {
        window.open(`https://api.attawoune.ml/api/v1/academics/report-cards/${id}/download_pdf/`, '_blank');
    };

    const downloadStatement = async () => {
        window.open(`https://api.attawoune.ml/api/v1/finance/student-balances/download_statement/?student_id=${student.id}`, '_blank');
    };
